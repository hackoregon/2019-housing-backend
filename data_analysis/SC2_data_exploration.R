...
source("../data/resources/utility_functions.R")

pdx_msa_definition <- c('41005', '41009', '41051', '41067', '41071', '53011', '53059')

hmda_pdx_working_07t17 <- readRDS("../data/cleaned_data/hmda_pdx_working_2007t2017.RDS")
homeownership_by_race_2017_3 <- readRDS("../data/cleaned_data/homeownership_by_race_2017_HMDA_summary.RDS")
homeownership_by_race_2011_3 <- readRDS("../data/cleaned_data/homeownership_by_race_2011_HMDA_summary.RDS")
