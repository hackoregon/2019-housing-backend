...
homeownership_by_race_2017_2 <- readRDS("../data/cleaned_data/race_by_tenure_1990t2017.RDS") %>%
...
homeownership_by_race_2011_2 <- readRDS("../data/cleaned_data/race_by_tenure_1990t2017.RDS") %>%
...
hmda_lar_pdx_2007t2017 <- readRDS("../data/raw_data/hmda_lar_pdx_2007-2017.RDS")
...
saveRDS(hmda_pdx_working, "../data/cleaned_data/hmda_pdx_working_2007t2017.RDS")
...
saveRDS(homeownership_by_race_2017_3, "../data/cleaned_data/homeownership_by_race_2017_HMDA_summary.RDS")
...
saveRDS(homeownership_by_race_2011_3, "../data/cleaned_data/homeownership_by_race_2011_HMDA_summary.RDS")
